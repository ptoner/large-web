...
declare const Framework7: any;
import { Web } from "./web";
import { PostUIService } from "./services/post-ui-service";
export { QuillService, UploadService, QueueService, ModelViewService, ModelView, PromiseView, Dom7, Template7, Framework7, PostUIService, Quill };
export default Web;
